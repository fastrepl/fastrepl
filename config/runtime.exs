...
#
#     PHX_SERVER=true bin/fastrepl start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :fastrepl, FastreplWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :fastrepl, Fastrepl.Repo,
    ssl: true,
    ssl_opts: [
      server_name_indication: ~c"ep-late-queen-a693d7y8.us-west-2.aws.neon.tech",
      verify: :verify_none
    ],
    url: database_url,
  ...
  config :fastrepl, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
