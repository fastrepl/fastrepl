...
<div
  class="flex flex-col gap-3 px-1 py-2 border border-black rounded-lg bg-gray-100 text-sm w-full items-center"
>
  <div class="font-semibold">Repository Indexing</div>
