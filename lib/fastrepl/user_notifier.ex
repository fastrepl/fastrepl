defmodule Fastrepl.UserNotifier do
  import Swoosh.Email
  import Phoenix.Component

  alias Fastrepl.Mailer

  @sender {"Fastrepl", "yujonglee@fastrepl.com"}
  ...
  def deliver_invite_link(email, %{url: url}) do
    ...
    deliver(
      to: email,
      subject: "You are invited to join Fastrepl!",
      html_body: html,
      text_body: text
    )
  end
  ...
  def invite_content(assigns) do
    ...
    <.email_layout>
      ...
      <p>Please use this link to sign in to Fastrepl:</p>
