defmodule FastreplWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :fastrepl
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :fastrepl
  end
